...
import reachy_mini_conversation_fleming.tool_spaces as tool_spaces_mod
...
def _reload_core_tools() -> ModuleType:
    for module_name in list(sys.modules):
        if module_name.startswith("reachy_mini_conversation_fleming.tools."):
            sys.modules.pop(module_name, None)

    sys.modules.pop("reachy_mini_conversation_fleming.tools.core_tools", None)
    return importlib.import_module("reachy_mini_conversation_fleming.tools.core_tools")

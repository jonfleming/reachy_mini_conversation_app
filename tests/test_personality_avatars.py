...
from reachy_desktop_buddy.avatars import (
    DEFAULT_AVATAR_FILE,
    avatar_id_for,
    read_avatar_svg,
)
from reachy_desktop_buddy.personality import save_user_personality
...
def test_avatar_unavailable_raises(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "reachy_desktop_buddy.personality_routes.read_avatar_svg",
        lambda name: None,
    )

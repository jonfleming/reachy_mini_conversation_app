...
import reachy_mini_conversation_fleming.conversation_handler as conv_mod
import reachy_mini_conversation_fleming.huggingface_realtime as hf_mod
from reachy_mini_conversation_fleming.config import config, get_default_voice
...
from reachy_mini_conversation_fleming.huggingface_realtime import HuggingFaceRealtimeHandler
from reachy_mini_conversation_fleming.tools.background_tool_manager import ToolState, ToolNotification
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            None,
            {
                "User-Agent": "reachy-mini-conversation-fleming",
        ...
        (None, None, None, None, {"User-Agent": "reachy-mini-conversation-fleming"}, "DUMMY", {}),
        (
            None,
            None,
            None,

...
from reachy_desktop_buddy.prompts import (
    get_session_voice,
    get_session_instructions,
    get_session_greeting_prompt,
)
from reachy_desktop_buddy.streaming import AdditionalOutputs, audio_to_int16
from reachy_desktop_buddy.tools.core_tools import (
    ToolSpec,
    ToolDependencies,
    get_tool_specs,
)
...
class HuggingFaceRealtimeHandler(ConversationHandler):
    ...
    async def _build_realtime_client(self) -> AsyncOpenAI:
        ...
        allocator_headers = {"User-Agent": "reachy-desktop-buddy"}
        if bearer_token:

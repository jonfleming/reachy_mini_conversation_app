...
from reachy_desktop_buddy.config import LOCKED_PROFILE, config
...
from reachy_desktop_buddy.profile_store import canonical_profile_name
from reachy_desktop_buddy.tool_settings import (
    RestartCallback,
    apply_tool_change,

...
from reachy_desktop_buddy.config import USER_PERSONALITIES_DIRNAME, config
...
from reachy_desktop_buddy.profile_store import DEFAULT_PROFILE_NAME, list_profile_names

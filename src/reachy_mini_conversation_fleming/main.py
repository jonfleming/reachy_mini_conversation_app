...
from reachy_mini_conversation_fleming import app_lifecycle
from reachy_mini_conversation_fleming.utils import (
    parse_args,
    setup_logger,
    ...
    if _import_warmup_thread is None:
        ...
        def _preload() -> None:
            try:
                ...
                import reachy_mini_conversation_fleming.huggingface_realtime  # noqa: F401
            except Exception:
...
def main() -> None:
    ...
    if args.command == "tool-spaces":
        from reachy_mini_conversation_fleming.tool_spaces import handle_tool_spaces_command
...
def run(
    ...
    if buddy_runtime.enabled:
        try:
            ...
            from reachy_mini_conversation_fleming.config import config as app_config

...
from reachy_mini_conversation_fleming.config import LOCKED_PROFILE, config
...
from reachy_mini_conversation_fleming.profile_store import canonical_profile_name
from reachy_mini_conversation_fleming.tool_settings import (
    RestartCallback,
    apply_tool_change,

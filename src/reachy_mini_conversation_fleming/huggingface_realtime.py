...
from reachy_mini_conversation_fleming.prompts import (
    get_session_voice,
    get_session_instructions,
    get_session_greeting_prompt,
)
from reachy_mini_conversation_fleming.streaming import AdditionalOutputs, audio_to_int16
from reachy_mini_conversation_fleming.tools.core_tools import (
    ToolSpec,
    ToolDependencies,
    get_tool_specs,
)
...
class HuggingFaceRealtimeHandler(ConversationHandler):
    ...
    async def _build_realtime_client(self) -> AsyncOpenAI:
        ...
        allocator_headers = {"User-Agent": "reachy-mini-conversation-fleming"}
        if bearer_token:

...
from reachy_mini_conversation_fleming.config import USER_PERSONALITIES_DIRNAME, config
...
from reachy_mini_conversation_fleming.profile_store import DEFAULT_PROFILE_NAME, list_profile_names

...
from reachy_mini_conversation_fleming.config import config, list_tool_module_names
from reachy_mini_conversation_fleming.mcp_client import McpToolTimeoutError, McpToolInvocationError
from reachy_mini_conversation_fleming.tool_spaces import build_remote_client, read_installed_tool_spaces
from reachy_mini_conversation_fleming.profile_store import DEFAULT_PROFILE_NAME
from reachy_mini_conversation_fleming.profile_toolsets import read_profile_tool_names
from reachy_mini_conversation_fleming.tools.tool_constants import SystemTool


if TYPE_CHECKING:
    from reachy_mini_conversation_fleming.mcp_client import RemoteMcpToolClient
    from reachy_mini_conversation_fleming.tools.background_tool_manager import BackgroundToolManager
...
_EXTERNAL_TOOL_MODULE_NAMESPACE = "reachy_mini_conversation_fleming._external_tools"
...
def _load_enabled_tools(tool_names: list[str], remote_tool_names: set[str]) -> List[type[Tool]]:
    ...
    for tool_name in tool_names:
        ...
        shared_module_path = f"reachy_mini_conversation_fleming.tools.{tool_name}"
        try:

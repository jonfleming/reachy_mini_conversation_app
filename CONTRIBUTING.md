...
- Tagged releases are automatically synchronized to [fleming-ai/reachy_desktop_buddy](https://huggingface.co/spaces/fleming-ai/reachy_desktop_buddy)
- Pull requests opened from branches in this repository automatically get a private preview Space named `reachy_desktop_buddy_PR<PR number>`
